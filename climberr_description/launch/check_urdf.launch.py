...
def generate_launch_description():
    ...
    pkg_urdf_path = FindPackageShare('climberr_description')
    default_rviz_config_path = PathJoinSubstitution([pkg_urdf_path, 'rviz', 'climberr_description.rviz'])
    ...
    urdf = IncludeLaunchDescription(
        ...
        launch_arguments={
            'urdf_package': 'climberr_description',
